 ...
 */
class CRM_Roomentity_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Roomentity_Upgrader(
        'com.civicrm.roomentity',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Roomentity_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
